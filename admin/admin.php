...
?>
                        ...
                        <div class="col">
                          <img src="images/users.png" class="img-fluid img-responsive rounded float-right mx-auto d-block w-50 h-70 image-animated" alt="...">
...
FROM users 
INNER JOIN pregnancy_informations 
ON users.id = pregnancy_informations.patient_id 
WHERE pregnancy_informations.due_date IS NOT NULL 
ORDER BY users.id
";
$query_run = mysqli_query($conn, $query);
...
?>
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <a href="pregnant_patient.php" class="btn btn-info btn-icon-split btn-sm">
                        <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                        </span>
                        <span class="text text-xs mt-1">View Details</span>
...
<span class="h4 font-weight-bold text-gray-900">
                        ...
                        <div class="col">
                          <img src="images/doctor.png" class="img-fluid img-responsive rounded float-right mx-auto d-block w-50 h-70 image-animated" alt="...">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <a href="doctors.php" class="btn btn-info btn-icon-split btn-sm">
                        <span class="icon text-white-50">
                            <i class="fas fa-arrow-right"></i>
                        </span>
                        <span class="text text-xs mt-1">View Details</span>
