...
<style type="text/css">
        body{
            ...
            min-height: 100vh;
            width: 100%;
            background: linear-gradient(to top, rgba(0, 0, 0, 0.5)50%, rgba(0, 0, 0, 0.5)), url(images/slides-02.jpg);
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="images/admin.png" class="img-fluid img-responsive w-75 h-75 mt-5 ml-5" style="width:100%; height:100%" alt="...">
                            </div>
                            <div class="col-lg-6">
