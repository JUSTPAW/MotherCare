...
<div class="d-sm-flex align-items-center justify-content-between mb-4 ml-3">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fa fa-user fa-1x text-gray-600 mr-1"></i>
         Users
    </h1>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    foreach($query_run as $row)
                    {
                        ...
                        <tr style="text-align:center">	
                            ...
                            <td>
                                        <a class="btn btn-sm btn-outline-primary" href="users_view.php?id=<?= $row['id']; ?>"
                                        ...
                                        <form action="code.php" method="POST" class="d-inline">
                                            <button type="submit" name="delete_patient_user" value="<?=$row['id'];?>" class="btn btn-sm btn-outline-danger" onclick="msg()" 
