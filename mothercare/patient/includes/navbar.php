...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Pregnancy"
        aria-expanded="true" aria-controls="Pregnancy">
        <i class="fas fa-fw fa-heartbeat "></i>
        <span>Pregnancy</span>
    </a>
    <div id="Pregnancy" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pregnancy:</h6>
            <a class="collapse-item" href="pregnancy.php">Pregnancy Informations</a>
            <a class="collapse-item" href="doctor_select.php">Choose Doctor</a>
            <a class="collapse-item" href="due_date.php">Due Date Calculator</a>
            <a class="collapse-item" href="name_generator.php">Baby Name Generator</a>
...
<div class="sidebar-card d-none d-lg-flex">
    ...
    <a class="btn btn-success btn-sm" href="../index.html">Go to Homepage!</a>
</div>
...
<span class="badge badge-danger badge-counter" id="message-counter"> 
    <?php
    $query = "SELECT id FROM messages WHERE recipient = '".$_SESSION['id']."' ORDER BY id";
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
        ...
        <?php 
            $query = "SELECT m.*, d.firstname, d.middlename, d.lastname 
                      FROM messages m 
                      JOIN doctors d ON m.sender = d.id 
                      WHERE m.recipient = '".$_SESSION['id']."' 
                      ORDER BY m.id DESC 
                      LIMIT 2";
        ...
        <a class="dropdown-item d-flex align-items-center" href="chats.php?id=<?= $mes['id']; ?>" 
            ...
            <div class="font-weight-bold">
                <div class="text-truncate">Dr. <?= $mes['firstname'] . ' ' . $mes['middlename'][0] . '. ' . $mes['lastname']; ?></div>
                <div class="small text-gray-500 text-truncate"><?= $mes['message']; ?> · <?= date('M, d Y . h:i a', strtotime($mes['date_created'])); ?>
</div>
            </div>
        </a>
...
<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
    ...
    <span class="mr-1 mt-2 d-none d-lg-inline text-info small text-uppercase">
        <?php
            ...
            $sql = "SELECT firstname, lastname, middlename, image FROM users WHERE user_name = ?";
