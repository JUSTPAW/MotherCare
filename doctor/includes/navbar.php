...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsPatients"
        aria-expanded="true" aria-controls="collapsPatients">
        <i class="fas fa-fw fa-wheelchair"></i> 
        <span>Patients</span>
    </a>
    <div id="collapsPatients" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Options:</h6>
            <a class="collapse-item" href="patients.php">Manage Patients</a>
            <a class="collapse-item" href="pregnancy_records.php">Pregnancy Records</a>
        </div>
    </div>
</li>
<li class="nav-item">
...
<span class="badge badge-danger badge-counter" id="message-counter"> 
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
        ...
        <?php 
            $query = "SELECT m.*, u.id, u.firstname, u.middlename, u.lastname 
                      FROM messages m 
        ...
        <a class="dropdown-item d-flex align-items-center" href="chats.php?id=<?= $mes['id']; ?>" 
            ...
            <div class="font-weight-bold">
                <div class="text-truncate"><?= $mes['firstname'] . ' ' . $mes['middlename'][0] . '. ' . $mes['lastname']; ?></div>
...
<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
    ...
    <span class="mr-1 mt-2 d-none d-lg-inline text-info small text-uppercase">
        <?php
            ...
            $sql = "SELECT firstname, lastname, middlename, image FROM doctors WHERE user_name = ?";
    ...
    <?php
        if (isset($row['image']) && !empty($row['image'])) {
            ...
            $profile_picture = "img/doctor.png";
        }
    ?>
