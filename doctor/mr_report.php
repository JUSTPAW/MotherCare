...
?>
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4 ml-1">
    ...
    <a href="mr_report.php" class="btn btn-sm btn-info shadow-sm" value="print" onclick="PrintDiv();">
                            ...
                            <?php 
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $no=1;
                                     $query = "SELECT u.*, mr.* 
                                              FROM users u 
                                              INNER JOIN pregnancy_records mr ON u.id = mr.patient_id 
                                    ...
                                    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                        $from_date = $_GET['from_date'];
                                        $to_date = $_GET['to_date'];
                                        $query .= " AND mr.date_created BETWEEN '$from_date' AND '$to_date'";
                                    }
